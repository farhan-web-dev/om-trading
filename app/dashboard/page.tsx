...
//   const totalPnL = openPositions?.reduce((sum: number, pos: any) => sum + (pos.unrealizedPnL || 0), 0) || 0;
...
//             </CardHeader>
//             <CardContent>
//               <div className="text-2xl font-bold">${balance?.total?.toFixed(2) || '0.00'}</div>
//               <p className="text-xs text-muted-foreground mt-1">Available: ${balance?.available?.toFixed(2) || '0.00'}</p>
//             </CardContent>
//           </Card>
...
//                 {totalPnL >= 0 ? '+' : ''}{((totalPnL / (balance?.total || 1)) * 100).toFixed(2)}%
//               </p>
//             </CardContent>
//           </Card>
...
//               <p className="text-xs text-success mt-1">+{portfolio?.change24h?.toFixed(2) || '0.00'}%</p>
//             </CardContent>
//           </Card>
//         </div>
...
//                           <span className="text-sm font-bold text-primary">{coin.symbol?.substring(0, 2)}</span>
//                         </div>
//                         <div>
...
//                         <div className="font-semibold">${coin.price?.toFixed(2)}</div>
//                         <div className={`text-sm flex items-center gap-1 ${coin.change24h >= 0 ? 'text-success' : 'text-error'}`}>
...
//                     <div key={position.id} className="p-3 bg-secondary rounded-lg">
//                       <div className="flex justify-between items-start mb-2">
//                         <div>
//                           <div className="font-semibold">{position.symbol}</div>
//                           <div className="text-xs text-muted-foreground">{position.side.toUpperCase()}</div>
//                         </div>
//                         <div className={`text-sm font-semibold ${position.unrealizedPnL >= 0 ? 'text-success' : 'text-error'}`}>
